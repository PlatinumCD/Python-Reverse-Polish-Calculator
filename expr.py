...
class BinOp(Expr):
    """Abstract class for the Binary Operators"""
    ...
    def eval(self, env: Env):
        log.debug('Evaluating {} and {} in BinOp'.format(self.left, self.right))
        lval = self.left.eval(env)
...
class Times(BinOp):
    """Subclass of BinOp. Multiplication"""

    def _apply(self, lval: Real, rval: Real):
        return lval * rval

    def __repr__(self):
        return "Times({})".format(repr(self))
...
class Div(BinOp):
    """Subclass of BinOp. Division"""

    def _apply(self, lval: Real, rval: Real):
        return lval / rval

    def __repr__(self):
        return "Plus({})".format(repr(self))
